			...
			case 4: //Tenemos una reina blanca
				...
				if ((vectorcin.x == int(pos1.y)) && (vectorcin.y == int(pos1.x))) {
					...
					if (retorno.x == 1) {
						...
						tablero.ocupado[int(pos2.y)][int(pos2.x)] = 4;

						tablero.jugador[int(pos1.y)][int(pos1.x)] = 2;
						tablero.jugador[int(pos2.y)][int(pos2.x)] = 0;
					}
			...
			case 5://Tenemos un Rey
				...
				retorno = rey1.mov_posible(pos1, pos2, n); {
					if (retorno.x == 1) {
						...
						tablero.ocupado[int(pos1.y)][int(pos1.x)] = 0;
						tablero.ocupado[int(pos2.y)][int(pos2.x)] = 5;
		...
		///AQUIIII
			...
			case 4: //Tenemos una reina blanca
				...
				if ((vectorcin.x == int(pos1.y)) && (vectorcin.y == int(pos1.x))) {
					...
					tablero.jugador[int(pos1.y)][int(pos1.x)] = 2;
					tablero.jugador[int(pos2.y)][int(pos2.x)] = 1;
			}
				break;
